        ...
        public override void SetChatButtons(ref string button, ref string button2)
        {
			...
			for (int k = 0; k < 255; k++)
			{
				...
				if (player.active)
				{
					...
					{
						if (player.inventory[j].type == 3389)//Terrarian
                        {
							C11 = true;
						}
						...
						if (player.inventory[j].type == 1326)//Rod of Discord
                        {
							C13 = true;
						}
						if (player.inventory[j].type == 3366)//Yoyo Bag
                        {
							C14 = true;
						}
						...
						if (player.inventory[j].type == 495)//Rainbow Rod
                        {
							C21 = true;
						}
						if (player.inventory[j].type == 3541)//Last Prism
                        {
							C22 = true;
						}
						if (player.inventory[j].type == 493)//Angel Wings
                        {
							C23 = true;
						}
						if (player.inventory[j].type == 1611)//Butterfly Dust
                        {
							C24 = true;
						}
						if (player.inventory[j].type == 2890)//Gold Bunny
                        {
							C25 = true;
						}
						...
						if (player.inventory[j].type == 2882)//Charged Blaster Cannon
                        {
							C31 = true;
						}
						if (player.inventory[j].type == 1295)//Heat Ray
                        {
							C32 = true;
						}
						if (player.inventory[j].type == mod.ItemType("AlchemicalBundle"))
						...
						if (player.inventory[j].type == 1858)//Sniper Scope
                        {
							C34 = true;
						}
						...
						if (player.inventory[j].type == 1363)//Skeletron Trophy
                        {
							C42 = true;
						}
						...
						if (player.inventory[j].type == 1156)//Piranha Gun
                        {
							C51 = true;
						}
						if (player.inventory[j].type == mod.ItemType("AlchemicalBundle"))
						...
						if (player.inventory[j].type == 900)//Moon Stone
                        {
							C54 = true;
						}
						...
						if (player.inventory[j].type == 1327)//Death Sickle
                        {
							C61 = true;
						}
						if (player.inventory[j].type == mod.ItemType("HateVial"))
						...
						if (player.inventory[j].type == 1865)//Celestial Stone
                        {
							C64 = true;
						}
