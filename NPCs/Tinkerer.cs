            ...
            if (firstButton)
            {
                ...
                else if (AlchemistNPCWorld.foundT1 || AlchemistNPCWorld.foundT2 || AlchemistNPCWorld.foundT3)
                {
                    ...
                    for (int k = 0; k < inventory.Length; k++)
                    {
                        ...
                        {
                            if (inventory[k].type == mod.ItemType("PaperTube") && inventory[k].stack > 0)
                            {
                                TubePresent = false;
                                TubePresent2 = false;
                                TubePresent3 = false;
                        ...
                        {
                            if (inventory[k].type == mod.ItemType("PaperTube2") && inventory[k].stack > 0)
                            {
                                TubePresent = false;
                                TubePresent2 = false;
                                TubePresent3 = false;
                        ...
                        {
                            if (inventory[k].type == mod.ItemType("PaperTube3") && inventory[k].stack > 0)
                            {
                                TubePresent = false;
                                TubePresent2 = false;
                                TubePresent3 = false;
