		...
		public override void Kill(int timeLeft)
		{
			...
			if (projectile.owner == Main.myPlayer)
			{
				...
				for (int index = 0; index < num2; ++index)
				{
					...
					Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, vector2.X*4f, vector2.Y*4f, ProjectileID.BallofFrost, projectile.damage, 1f, projectile.owner, 0.0f, Main.rand.Next(-45, 1));
				}
			}
		}
