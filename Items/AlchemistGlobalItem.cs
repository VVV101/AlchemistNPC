...
namespace AlchemistNPC.Items
{
    public class AlchemistGlobalItem : GlobalItem
    {
        ...
        public override void ModifyTooltips(Item item, List<TooltipLine> tooltips)
        {
            ...
            string StormWeaver = Language.GetTextValue("Mods.AlchemistNPC.StormWeaver");
            string CeaselessVoid = Language.GetTextValue("Mods.AlchemistNPC.CeaselessVoid");
            string Signus = Language.GetTextValue("Mods.AlchemistNPC.Signus");
            ...
            string ExoMechs = Language.GetTextValue("Mods.AlchemistNPC.ExoMechs");
            string SupremeCalamitas = Language.GetTextValue("Mods.AlchemistNPC.SupremeCalamitas");
