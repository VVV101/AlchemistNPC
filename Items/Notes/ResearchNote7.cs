...
namespace AlchemistNPC.Items.Notes
{
	public class ResearchNote7 : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			+"\nThere was one old man-scientist, named [c/00FF00:Rick]."
			...
			+"\nThe thing what I was the most intrested in is his Portal Gun."
			+"\nHe managed to use it as a weapon. And I really want to make one for myself.."
			+"\nOf course, we need [c/00FF00:Portal Gun] as the base..."
			...
			+"\nSomething, named [c/00FF00:Concentrated Dark Matter] is required."
			+"\nHope I would be able to synthesize it...''");
