...
namespace AlchemistNPC.Items
{
	public class TornNote2 : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			+ "\nIf Wing of the World is placed in empty housing, it could attract special NPC, called Operator."
			+ "\nAnd if anyone still asking, what EGO stands for, then here it is: Extermination of Geometrical Organ.'"
			+ "\nThere is something else, but you couldn't read this. Not without parts #1 & #3. Maybe Jeweler could help you.");
