...
namespace AlchemistNPC.Items.Misc
{
	public class PaperTube2 : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			DisplayName.AddTranslation(GameCulture.Chinese, "纸管 (T-2)");
		...
		public override bool UseItem(Player player)
        {
			...
			{
				Main.NewText("You have found all early hardmode blueprints. Congratulations! Now you may sell all leftover Paper Tubes to Tinkerer.", 0, 255, 0);
