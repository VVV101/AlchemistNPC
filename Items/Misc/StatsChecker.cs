...
namespace AlchemistNPC.Items.Misc
{
	public class StatsChecker : ModItem
	{
		...
		public override void ModifyTooltips(List<TooltipLine> tooltips)
		{
			...
			string text1 = Language.GetTextValue("Mods.AlchemistNPC.Pip-Boy 3000text1") + (int)((player.meleeDamage*100)-100) + "%" + " / " + (player.meleeCrit-4) + "%";
			string text2 = Language.GetTextValue("Mods.AlchemistNPC.Pip-Boy 3000text2") + (int)((player.rangedDamage*100)-100) + "%" + " / " + (player.rangedCrit-4) + "%";
			string text3 = Language.GetTextValue("Mods.AlchemistNPC.Pip-Boy 3000text3") + (int)((player.magicDamage*100)-100) + "%" + " / " + (player.magicCrit-4) + "%";
			string text4 = Language.GetTextValue("Mods.AlchemistNPC.Pip-Boy 3000text4") + (int)((player.thrownDamage*100)-100) + "%" + " / " + (player.thrownCrit-4) + "%";
			string text5 = Language.GetTextValue("Mods.AlchemistNPC.Pip-Boy 3000text5") + (int)((player.minionDamage*100)-100) + "%";
			string text6 = Language.GetTextValue("Mods.AlchemistNPC.Pip-Boy 3000text6") + (int)(player.endurance*100) + "%";
			string text7 = Language.GetTextValue("Mods.AlchemistNPC.Pip-Boy 3000text7") + (int)((player.moveSpeed*100)-100) + "%";
			string text8 = Language.GetTextValue("Mods.AlchemistNPC.Pip-Boy 3000text8") + (player.statLifeMax2 - player.statLifeMax);
			string text9 = Language.GetTextValue("Mods.AlchemistNPC.Pip-Boy 3000text9") + (player.lifeRegen);
			string text10 = Language.GetTextValue("Mods.AlchemistNPC.Pip-Boy 3000text10") + (int)((player.manaCost*100)-100) + "%";
			string text11 = Language.GetTextValue("Mods.AlchemistNPC.Pip-Boy 3000text11") + player.maxMinions + " / " + player.maxTurrets;
			string text12 = Language.GetTextValue("Mods.AlchemistNPC.Pip-Boy 3000text12") + (int)(player.meleeSpeed*100) + "%";
